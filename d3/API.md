...
D3 é uma coleção de módulos projetados para trabalhar em conjunto; você pode usar os módulos de forma independente ou pode usá-los juntos como parte da compilação padrão. A fonte e a documentação de cada módulo estão disponíveis em seu repositório. Siga os links abaixo para saber mais. Para alterações entre as versões principais, consulte CHANGES; veja também as notas de lançamento e a referência 3.x.
